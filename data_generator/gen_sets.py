...
#getDatasetFromDistA(sample_set[:, int(T * 0.05):], data_folder="../training_data/treino/", ti=0, tf=50)
print("Generating validation data")
#getDatasetFromDistA(sample_set[:, 0:int(T * 0.01)], data_folder="../training_data/validation/", ti=0, tf=50)
...
print(np.shape(sample_set))
#print(sample_set)
sample_set=np.tile(sample_set, ( 1, int(2)))
print(np.shape(sample_set))
...
getDatasetFromDistA(sample_set[:,:len(sample_set.T)//2],data_folder="../training_data/treino/",ti=0,tf=50)

getDatasetFromDistA(sample_set[:,len(sample_set.T)//2:],data_folder="../training_data/treino_val/",ti=0,tf=50)