...
def train(model_params,outputfolder,gpuid):
        ...
        data_int,data_outt=LoadDataSet("training_data/treino/",device=device,dtype=dtype)
        data_inv,data_ouv=LoadDataSet("training_data/validation/",device=device,dtype=dtype)
